...
build: bin
	...
	$(CC) -mmcu=atmega328p obj/main.o obj/process_management.o obj/scheduling.o obj/timer.o obj/ardos.o obj/process.o obj/semaphore.o obj/external_interrupts.o obj/digital_io.o -o bin/main
